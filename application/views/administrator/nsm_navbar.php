    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-primary" href="<?= base_url('administrator/navbar/create') ?>">
                                <i class="fa fa-plus"></i> Create Navbar
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Navigation Bar</h4>
                </div>
                <div class="pb-20">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item"
                                                href="<?= base_url("administrator/navbar/edit/$row->id") ?>"><i
